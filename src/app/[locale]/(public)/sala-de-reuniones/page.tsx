    ...
    <div className="min-h-screen bg-white pb-20 overflow-hidden">
            ...
            <div className="lg:col-span-12 xl:col-span-6">
              ...
              <div className="grid grid-cols-2 gap-4 py-4 border-y border-gray-100 mb-6">
                <div className="flex flex-col gap-0.5">
                  <span className="text-xl font-serif font-bold text-brand-blue">15 - 350</span>
                  <span className="text-[9px] uppercase font-bold text-gray-400 tracking-widest">{isEs ? "Capacidad" : "Capacity"}</span>
                </div>
                <div className="flex flex-col gap-0.5">
                  <span className="text-xl font-serif font-bold text-brand-green">100%</span>
                  <span className="text-[9px] uppercase font-bold text-gray-400 tracking-widest">{isEs ? "Equipado" : "Equipped"}</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-8 bg-gray-50/50">
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl text-center">
            <h2 className="text-2xl md:text-3xl font-serif font-bold text-gray-900 mb-8 italic">
              {isEs ? "Experiencias a su medida" : "Bespoke Experiences"}
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Corporate */}
              <div className="group bg-white p-6 md:p-8 rounded-[2.5rem] border border-gray-100 hover:shadow-lg transition-all duration-500 overflow-hidden relative">
                <div className="absolute top-0 right-0 p-4 text-brand-blue/5 transform rotate-12 group-hover:rotate-0 transition-transform duration-500">
              ...
              {/* Social */}
              <div className="group bg-white p-6 md:p-8 rounded-[2.5rem] border border-gray-100 hover:shadow-lg transition-all duration-500 overflow-hidden relative">
                <div className="absolute top-0 right-0 p-4 text-brand-green/5 transform rotate-12 group-hover:rotate-0 transition-transform duration-500">
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Catering Box */}
            <div className="bg-brand-green-50 rounded-[2rem] p-8 border border-brand-green-100 flex flex-col justify-between group">
               <div>
                  <h3 className="text-lg font-serif font-bold text-gray-900 mb-3 flex items-center gap-3">
         ...
         <div className="bg-white rounded-[2.5rem] shadow-lg p-8 md:p-12 border border-gray-100 relative">
            ...
            <div className="max-w-xs mx-auto space-y-4">
              <WhatsAppBookingButton
                ...
                roomId="eventos"
                locale={locale}
                className="w-full h-12 bg-brand-blue hover:bg-brand-blue-700 text-white rounded-[0.75rem] shadow-md transition-all transform hover:scale-[1.02] active:scale-[0.98] font-bold text-base flex items-center justify-center gap-3"
              />
              <p className="text-[9px] text-gray-400 font-medium italic">{isEs ? "* Presupuestos personalizados" : "* Custom quotes"}</p>
            </div>

            <div className="flex items-center justify-center gap-4 text-gray-100 mt-8">
               <span className="h-px w-12 bg-gray-50" />
               <p className="text-[9px] uppercase tracking-[0.2em] font-bold italic text-gray-200">{isEs ? "Tradición & Excelencia" : "Tradition & Excellence"}</p>
               <span className="h-px w-12 bg-gray-50" />
            </div>
         </div>
      </section>
