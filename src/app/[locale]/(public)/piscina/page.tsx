      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-16">
          <div className="lg:col-span-12 xl:col-span-5">
            ...
            <div className="space-y-4 text-gray-600 text-lg mb-8 leading-relaxed font-light">
              <p>
                {isEs 
            ...
            <div className="flex items-center gap-6 py-6 border-y border-gray-100 mb-8 max-w-md">
              <div className="text-center flex-1">
                <p className="text-brand-blue font-serif text-2xl font-bold">28°C</p>
                <p className="text-gray-400 text-[10px] uppercase tracking-widest mt-0.5">Temp. Promedio</p>
              </div>
              <div className="w-px h-10 bg-gray-100" />
              <div className="text-center flex-1">
                <p className="text-brand-green font-serif text-2xl font-bold">1.4m</p>
                <p className="text-gray-400 text-[10px] uppercase tracking-widest mt-0.5">Profundidad Máx.</p>
              </div>
            </div>
          </div>

          <div className="lg:col-span-12 xl:col-span-7 grid grid-cols-12 gap-4 items-center">
            <div className="col-span-8 aspect-[16/10] rounded-[2rem] overflow-hidden shadow-xl ring-4 ring-white transform hover:scale-[1.02] transition-all duration-700">
              <SmartImage
            ...
            <div className="col-span-4 aspect-[4/5] rounded-[1.5rem] overflow-hidden shadow-lg ring-2 ring-white transform -ml-8 relative z-10 hover:scale-[1.05] transition-all duration-700">
              <SmartImage
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          <div className="bg-brand-blue-50 p-8 rounded-[2rem] flex flex-col justify-between border border-brand-blue-100/30">
            <div>
              <Clock className="w-8 h-8 text-brand-blue mb-6" />
              <h3 className="text-xl font-serif font-bold text-gray-900 mb-3">{t("schedule")}</h3>
          ...
          <div className="bg-brand-green-50 p-8 rounded-[2rem] flex flex-col justify-between border border-brand-green-100/30">
            <div>
              <CheckSquare className="w-8 h-8 text-brand-green mb-6" />
              <h3 className="text-xl font-serif font-bold text-gray-900 mb-3">{t("price")}</h3>
          ...
          <div className="bg-brand-blue-900 p-8 lg:p-10 rounded-[2rem] shadow-xl text-white md:col-span-2 lg:col-span-1">
