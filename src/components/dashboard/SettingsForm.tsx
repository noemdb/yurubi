    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-gray-100 dark:border-slate-800 shadow-sm dark:shadow-none space-y-6">
            <h3 className="text-xl font-serif font-bold text-gray-900 dark:text-gray-100 flex items-center gap-3">
          ...
          <div className="space-y-10">
            ...
            <div className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-gray-100 dark:border-slate-800 shadow-sm dark:shadow-none space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{isEs ? `Precio Entrada Piscina (${CURRENCY_SYMBOL})` : `Pool Entrance Price (${CURRENCY_SYMBOL})`}</FormLabel>
        ...
        <Button 
          ...
          className="bg-brand-blue hover:bg-brand-blue/90 text-white rounded-2xl h-16 px-12 shadow-lg dark:shadow-none shadow-brand-blue/20 gap-3 font-bold transition-all active:scale-95"
        >
