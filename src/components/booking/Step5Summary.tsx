    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 animate-in fade-in slide-in-from-right-8 duration-500">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <Button variant="ghost" onClick={!isSubmitting ? onBack : undefined} disabled={isSubmitting} className="text-brand-blue rounded-xl h-10 px-4 hover:bg-brand-blue-50">
        ...
        <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
          ...
          <div className="space-y-3 text-sm text-gray-700">
            <p className="flex justify-between items-center border-b border-gray-100 pb-2">
                <span className="font-semibold text-gray-400">{isEs ? "Titular:" : "Name:"}</span> 
                <span className="font-medium text-gray-900 text-right">{bookingData.guest?.fullName}</span>
            </p>
            <p className="flex justify-between items-center border-b border-gray-100 pb-2">
                <span className="font-semibold text-gray-400">{isEs ? "Documento:" : "ID:"}</span> 
                <span className="font-medium text-gray-900 text-right">{bookingData.guest?.idDocument}</span>
            </p>
            <p className="flex justify-between items-center border-b border-gray-100 pb-2">
                <span className="font-semibold text-gray-400">Email:</span> 
                <span className="font-medium text-gray-900 text-right">{bookingData.guest?.email}</span>
            </p>
      ...
      <div className="lg:col-span-1">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 h-full relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="bg-gray-50 rounded-2xl p-4 space-y-3 mb-6 border border-gray-100">
              ...
              <div className="flex justify-between text-sm text-gray-600">
                ...
                <div className="flex flex-col items-end">
                   ...
                   <span className="font-bold text-gray-900">{formatPrice(bookingData.price || 0)}</span>
                </div>
              </div>
              <div className="flex justify-between text-sm text-gray-600">
            ...
            <div className="flex justify-between items-end pt-4 border-t border-gray-100">
              <span className="text-label text-gray-900">{isEs ? "Total a Pagar" : "Total"}</span>
