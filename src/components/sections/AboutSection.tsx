...
export function AboutSection({ locale }: AboutSectionProps) {
  ...
  useEffect(() => {
    if (videoRef.current) {
      // Intentar reproducir automáticamente para evitar bloqueos del navegador en algunos contextos de React
  ...
  return (
    <div className="bg-white dark:bg-gray-950">
      ...
      {/* 1.5 Brand Identity Section (Video) */}
      <section className="py-24 bg-gray-50/50 dark:bg-gray-900/30 overflow-hidden border-b border-gray-100 dark:border-gray-800">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <SectionReveal className="order-2 lg:order-1 flex justify-center">
              <div
                suppressHydrationWarning
                className="relative w-full max-w-[464px] rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white dark:border-gray-800 bg-gray-100 dark:bg-gray-900 group"
            ...
            <SectionReveal className="order-1 lg:order-2">
              ...
              <h2 className="font-serif text-3xl md:text-5xl font-bold text-gray-900 dark:text-gray-50 mb-8 leading-tight">
                {t("identityTitle")}
              </h2>
              <p className="text-gray-600 dark:text-gray-400 text-xl leading-relaxed italic border-l-4 border-brand-green pl-6 py-2">
                {t("identityContent")}
              </p>
            </SectionReveal>
          </div>
