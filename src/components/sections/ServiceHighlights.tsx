    ...
    <section className="py-8 bg-background border-t border-border">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {highlights.map((item) => (
            <div key={item.id} className="group relative bg-card rounded-md overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-border/60 flex flex-col">
              <div className="aspect-[4/3] overflow-hidden relative">
                ...
                <div className="absolute top-6 left-6 bg-background p-3 rounded-sm shadow-lg ring-1 ring-black/5 dark:ring-white/10">
                  {item.icon}
                </div>
              </div>
