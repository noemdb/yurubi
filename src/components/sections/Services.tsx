        ...
        >
          {services.map((service) => (
            <motion.div
              ...
              className="p-10 rounded-3xl bg-card border border-border/60 shadow-sm hover:shadow-xl transition-all group cursor-default"
            >
              <div className="mb-8 inline-flex p-5 bg-muted rounded-2xl shadow-inner group-hover:scale-110 group-hover:bg-brand-green/10 transition-all duration-300">
                {service.icon}
              </div>
