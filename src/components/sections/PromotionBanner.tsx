    ...
    <div className="bg-brand-blue-900 py-2.5 px-4 text-white overflow-hidden relative border-b border-white/5">
      <div className="container mx-auto flex items-center justify-center gap-6 text-center relative z-10">
        <div className="flex items-center gap-2">
          <div className="bg-brand-green/20 p-1.5 rounded-sm">
        ...
        <Link 
          ...
          className="group text-[10px] font-bold uppercase tracking-widest bg-white/10 hover:bg-brand-green hover:text-brand-blue-900 px-4 py-1.5 rounded-lg flex items-center gap-2 transition-all duration-300 border border-white/10 hover:border-brand-green"
        >
